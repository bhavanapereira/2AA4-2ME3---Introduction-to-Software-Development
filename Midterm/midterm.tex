...
\item \textbf{generality}: The set is not general, in that it operates specifically on sets of integer values. If the module was to be used for a set of any other type (string, character, etc.), in order for it to work. 
