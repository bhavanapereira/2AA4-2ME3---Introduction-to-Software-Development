...
#  @param the method takes in four natural numbers x,y,s,m 
#  to represent the x coordinate, the y coordinate, the sidelengths
...
#  and dividind the product by 12, this method returns the value of the
#  moment of inertia
    def m_inert(self):
